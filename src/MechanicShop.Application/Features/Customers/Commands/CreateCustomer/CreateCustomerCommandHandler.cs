        ...
        CancellationToken ct)
    {
        ...
        foreach(var v in command.Vehicles)
        {
            var vehicleResult = Vehicle.Create(
                Guid.NewGuid(), v.Make, v.Model, v.Year, v.LicensePlate);
        ...
        _logger.LogInformation("Customer create successfully. Id: {customerId}", customer.Id);
